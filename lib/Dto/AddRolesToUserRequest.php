...
/**
 * AddRolesToUserRequest Class Doc Comment
 *
 * @category Class
 * @package  Ensi\AdminAuthClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AddRolesToUserRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddRolesToUserRequest';
     ...
     * Sets roles
     *
     * @param int[] $roles Идентификаторы добавляемых ролей
     *
     * @return $this
     */
     ...
     * Sets expires
     *
     * @param \DateTime|null $expires Время жизни роли
     *
     * @return $this
     */
