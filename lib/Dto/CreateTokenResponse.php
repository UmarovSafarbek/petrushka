...
/**
 * CreateTokenResponse Class Doc Comment
 *
 * @category Class
 * @package  Ensi\AdminAuthClient
 * @author   OpenAPI Generator team
...
class CreateTokenResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets token_type
     *
     * @param string $token_type Тип токена для доступа к api, в нашем случае всегда Bearer
     *
     * @return $this
     */
     ...
     * Sets access_token
     *
     * @param string $access_token Токен доступа в формате JWT
     *
     * @return $this
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token Токен по которому можно получить новый токен доступа
     *
     * @return $this
     */
