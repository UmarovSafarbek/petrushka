...
/**
 * DeleteRoleFromUserRequest Class Doc Comment
 *
 * @category Class
 * @package  Ensi\AdminAuthClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DeleteRoleFromUserRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteRoleFromUserRequest';
     ...
     * Sets role_id
     *
     * @param int $role_id Идентификатор удаляемой роли
     *
     * @return $this
     */
